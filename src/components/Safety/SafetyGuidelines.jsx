...
const SafetyGuidelines = () => {
    ...
    const riderGuidelines = [
        ...
        },
        {
            ...
            description: "When traveling alone, sit in the back seat to give yourself and your driver personal space.",
        },
        {
    ...
    const guidelines = activeTab === "driver" ? driverGuidelines : riderGuidelines;

    return (
        <section className="w-full px-4 sm:px-6 py-10 bg-[#1C2431] text-white">
            <div className="max-w-4xl mx-auto text-center mb-6">
                ...
                <div className="max-w-4xl mx-auto flex  flex-row  items-center gap-1 mb-6">
                    <button
                        ...
                        className={`w-full sm:w-1/2 py-2 rounded-lg  transition-all duration-300 ${activeTab === "rider"
                                ? "bg-black font-bold"
                    ...
                    <button
                        ...
                        className={`w-full sm:w-1/2 py-2 rounded-lg  transition-all duration-300 ${activeTab === "driver"
                                ? "bg-black font-bold"
                                : "border-transparent text-gray-300"
                            }`}
                    >
            ...
            <div className="max-w-4xl mx-auto rounded-xl bg-[#2B3443] p-6 sm:p-10 shadow-lg">
