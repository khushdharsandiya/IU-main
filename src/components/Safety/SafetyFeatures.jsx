...
const SafetyFeatures = () => {
  ...
  return (
    <div className="bg-[#0e1726] text-white py-16 px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
        {features.map((feature, index) => (
          <div
            key={index}
            className="bg-[#0b121f] rounded-xl p-6 text-center shadow-md hover:shadow-lg transition"
          >
            <div className="flex items-center justify-center mb-4">
              <div className="bg-[#101d33] p-4 rounded-full">
                {feature.icon}
              </div>
            </div>
